...
{
    public class UnitResourceDepositInfo : MonoBehaviour, IInfoModule
    {
        private ResourceDeposit _trackedStorage;
        ...
        public void SetStorage(ResourceDeposit storage)
        {
            _trackedStorage = storage;

            UpdateStoredAmount(storage.Value, storage.OriginalAmount);
